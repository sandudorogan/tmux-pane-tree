...
assert_file_contains "examples/pi-hook.sh" 'scripts/features/hooks/hook-pi.sh'
assert_file_contains "examples/kiro-hook.sh" 'scripts/features/hooks/hook-kiro.sh'
...
assert_file_contains "examples/pi-hook.sh" 'TMUX_PANE_TREE_PLUGIN_DIR'
assert_file_contains "examples/kiro-hook.sh" 'TMUX_PANE_TREE_PLUGIN_DIR'
...
assert_file_contains "README.md" 'Pi: `hook-pi.sh`'
assert_file_contains "README.md" 'Kiro: `hook-kiro.sh`'
