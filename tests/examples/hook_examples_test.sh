...
assert_file_contains "README.md" 'To patch Claude Code, Codex, Cursor, OpenCode, Pi, and Kiro hook config after a manual install:'
...
assert_file_contains "README.md" '~/.pi/agent/extensions/tmux-pane-tree.ts'
assert_file_contains "README.md" '~/.kiro/agents/tmux-pane-tree.json'
assert_file_contains "README.md" '~/.kiro/settings/cli.json'
...
assert_file_contains "README.md" '`chat.defaultAgent` when it is missing or still `kiro_default`'
