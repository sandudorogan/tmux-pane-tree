set -gF @tmux_pane_tree_dir "#{d:current_file}"
set -gF @tmux_sidebar_dir "#{d:current_file}"

if-shell -F '#{||:#{==:#{@tmux_pane_tree_install_agent_hooks},1},#{==:#{@tmux_sidebar_install_agent_hooks},1}}' "run-shell -b '#{@tmux_sidebar_dir}/scripts/features/hooks/install-agent-hooks.sh'"
